...
class AgentWithdrawalRequestStatusNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct($status, AgentWithdrawalRequest $withdrawalRequest)
    {
        $this->status = $status;

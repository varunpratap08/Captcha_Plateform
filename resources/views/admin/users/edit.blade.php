            ...
            <section class="container mx-auto">
                ...
                <div class="form-card">
                    <div class="card-header">
                        <h2>
                            <i class="fas fa-info-circle mr-2"></i> Edit User Details
                        </h2>
                    </div>
                    <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="@error('phone') error @enderror" id="phone" name="phone" value="{{ old('phone', $user->phone) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="referral_code" value="{{ $user->referral_code }}" disabled>
                                <i class="fas fa-lock icon"></i>
                                <small>Referral code cannot be changed</small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if($user->profile_photo_path)
                                    <img src="{{ asset('storage/' . $user->profile_photo_path) }}" alt="Profile Photo" class="profile-photo-preview">
                                @endif
                            </div>
                            ...
                            <div class="form-group col-span-2">
                                ...
                                @foreach($roles as $id => $name)
                                    <div class="custom-checkbox">
                                        <input type="checkbox" id="role_{{ $id }}" name="roles[]" value="{{ $id }}" {{ in_array($id, $userRoles) ? 'checked' : '' }}>

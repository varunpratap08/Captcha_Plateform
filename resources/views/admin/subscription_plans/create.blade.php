                    ...
                    <form action="{{ route('admin.subscription-plans.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="@error('name') error @enderror" value="{{ old('name') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="captcha_per_day" id="captcha_per_day" class="@error('captcha_per_day') error @enderror" value="{{ old('captcha_per_day') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="min_withdrawal_limit" id="min_withdrawal_limit" class="@error('min_withdrawal_limit') error @enderror" value="{{ old('min_withdrawal_limit') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" name="cost" id="cost" class="@error('cost') error @enderror" value="{{ old('cost') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" id="icon" class="@error('icon') error @enderror" value="{{ old('icon') }}" placeholder="e.g., fas fa-star">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="caption_limit" id="caption_limit" class="@error('caption_limit') error @enderror" value="{{ old('caption_limit') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="min_daily_earning" id="min_daily_earning" class="@error('min_daily_earning') error @enderror" value="{{ old('min_daily_earning') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="earning_type" id="earning_type" class="@error('earning_type') error @enderror" value="{{ old('earning_type') }}">
